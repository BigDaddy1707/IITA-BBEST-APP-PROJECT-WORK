...
class AdvancedOrderFilter extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdvancedOrderFilter> createState() =>
      _AdvancedOrderFilterState();
}
...
class _AdvancedOrderFilterState extends ConsumerState<AdvancedOrderFilter> {
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextField(
            ...
            onChanged: (value) {
              _updateCriteria(_criteria.copyWith(
  ...
  Widget _buildFilterSummary() {
    ...
    if (_criteria.startDate != null) {
      activeFilters.add(
          'From: ${DateFormat('MMM dd, yyyy').format(_criteria.startDate!)}');
    }
    if (_criteria.endDate != null) {
      activeFilters
          .add('To: ${DateFormat('MMM dd, yyyy').format(_criteria.endDate!)}');
    }
