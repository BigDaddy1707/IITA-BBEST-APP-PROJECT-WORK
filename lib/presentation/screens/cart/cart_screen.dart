...
class CartScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:
          isCartEmpty ? null : _buildCartSummary(context, ref, cart),
    );
  }
  ...
  Widget _buildCartItem(
      BuildContext context, WidgetRef ref, CartItemModel item) {
    return Padding(
  ...
  Widget _buildCartSummary(
      BuildContext context, WidgetRef ref, CartModel cart) {
